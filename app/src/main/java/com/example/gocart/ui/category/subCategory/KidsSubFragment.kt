...
import com.example.gocart.databinding.FragmentSubKidsBinding
...
class KidsSubFragment : Fragment(), RecyclerViewAdapterProduct.OnItemClickListener {
    private lateinit var _binding: FragmentSubKidsBinding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSubKidsBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        categoryViewModel.liveDataResponse3.observe(viewLifecycleOwner,{
            ...
            _binding.kidsRecycler.adapter=recyclerViewAdapterProduct
        })
    }
    private fun toolbarConfig() {
        activity!!.findViewById<Toolbar>(R.id.toolbar).apply {
            ...
            setNavigationOnClickListener { findNavController().navigate(R.id.kidsFragment) }

...
import com.example.gocart.databinding.FragmentKidsBinding
...
class KidsFragment : Fragment(), RecyclerViewAdapterProduct.OnItemClickListener {
    private lateinit var _binding: FragmentKidsBinding
    ...
    override fun onViewCreated(view: View,savedInstanceState: Bundle?) {
        ...
        _binding.floatingActionButton.setOnClickListener {
            ...
            findNavController().navigate(R.id.kidSubCategories,bundle)
        }

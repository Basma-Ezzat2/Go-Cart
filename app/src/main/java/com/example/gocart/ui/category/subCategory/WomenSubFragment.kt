...
import com.example.gocart.databinding.FragmentSubWomenBinding
...
class WomenSubFragment : Fragment(), RecyclerViewAdapterProduct.OnItemClickListener {

    private lateinit var _binding: FragmentSubWomenBinding
    ...
    override fun onCreateView(
        ...
        inflater.inflate(R.layout.fragment_sub_women, container, false)
        _binding = FragmentSubWomenBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        categoryViewModel.liveDataResponse.observe(viewLifecycleOwner,{
            ...
            _binding.womenRecycler.adapter=recyclerViewAdapterProduct
        })
    }
    private fun toolbarConfig() {
        activity!!.findViewById<Toolbar>(R.id.toolbar).apply {
            ...
            setNavigationOnClickListener { findNavController().navigate(R.id.womenFragment) }

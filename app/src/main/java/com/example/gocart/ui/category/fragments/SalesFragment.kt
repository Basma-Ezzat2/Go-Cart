...
class SalesFragment : Fragment(), RecyclerViewAdapterProduct.OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        inflater.inflate(R.layout.fragment_sales, container, false)
    ...
    override fun onViewCreated(view: View,savedInstanceState: Bundle?) {
        ...
        _binding.floatingActionButton.setOnClickListener {
            ...
            findNavController().navigate(R.id.saleSubCategories,bundle)
        }
        ...
        categoryViewModel.liveDataResponse4.observe(viewLifecycleOwner,{
            ...
            _binding.recyclerViewMyProduct4.adapter=recyclerViewAdapterProduct
        })
